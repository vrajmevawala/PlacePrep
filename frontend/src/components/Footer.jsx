        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 lg:gap-16">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center mb-6">
              <img src={footerlogo} alt="PlacePrep Logo" className="h-10 w-auto" />
            </div>
            <p className="text-gray-300 text-sm leading-relaxed mb-6">
              Your comprehensive platform for placement preparation. Master aptitude, technical, and DSA skills with expert-curated content and real-time assessments.
            </p>
          ...
          {/* Features */}
          <div className="lg:col-span-1">
            <h3 className="text-lg font-semibold mb-6 text-white">Our Features</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="flex items-center space-x-6 text-sm text-gray-400">
              <span>&copy; {new Date().getFullYear()} PlacePrep. All rights reserved.</span>
